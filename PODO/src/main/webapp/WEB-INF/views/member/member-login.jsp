...
<link rel="stylesheet"
	href="${contextPath}/resources/css/member/login.css">
<link rel="stylesheet"
		...
		<div id="login-contaioner">
			...
			<form action="login" method="POST" name="login-form" id="login-form" onsubmit="return loginValidate()">
				<fieldset id="login-area">
					...
					<section>
						<input type="text" id="ID-box" name="memberId" maxlength="20"
							placeholder="아이디를 입력해주세요."> <input type="password"
							id="PW-box" name="memberPw" placeholder="비밀번호를 입력해주세요.">
					</section>
				...
				<div class="under-login">
					<label> <input type="checkbox" name="saveId" id="saveId">
						아이디 저장
					</label> <a href="${contextPath}/member/findId">아이디 찾기 |</a> <a
