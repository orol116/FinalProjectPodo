...
ALTER TABLE ALARM ADD (RMEMBER_ID VARCHAR2(500));
COMMIT;
ALTER TABLE "BOARD_IMG" ADD CONSTRAINT "PK_BOARD_IMG" PRIMARY KEY (
	"IMG_NO"
);
ALTER TABLE ALARM DROP (RM);
...
INSERT INTO MEMBERAREA_XY VALUES(SEQ_MCRDNT_NO.NEXTVAL, 32, 126.976243215499, 37.5600786131308, NULL);
...
INSERT INTO REPORT_TYPE VALUES(1, '기타');
INSERT INTO REPORT_TYPE VALUES(2, '광고');
INSERT INTO REPORT_TYPE VALUES(3, '상품 정보 부정확');
INSERT INTO REPORT_TYPE VALUES(4, '거래 금지 품목');
INSERT INTO REPORT_TYPE VALUES(5, '허위 매물');
INSERT INTO REPORT_TYPE VALUES(6, '사기 의심');
...
SELECT BOARD_TITLE FROM ITEM_BOARD
WHERE BOARD_NO IN (
