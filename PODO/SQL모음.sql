...
CREATE OR REPLACE FUNCTION FN_LAST_MESSAGE_NO(INPUT_CHAT_NO NUMBER)
RETURN NUMBER
IS M_NO NUMBER;
BEGIN
    SELECT MESSAGE_NO
...
SELECT MEMBER_NO, MEMBER_NICK, MEMBER_PROFILE, 
	MESSAGE_CONTENT, MESSAGE_TIME, MESSAGE_NO
FROM CHAT_ROOM_JOIN

JOIN MEMBER USING(MEMBER_NO)
JOIN MESSAGE USING(CHAT_NO)
