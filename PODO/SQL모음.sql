...
COMMENT ON COLUMN "ITEM_CATEGORY"."CATEGORY_NO" IS '카테고리 번호(Like 게시글 번호)';

COMMENT ON COLUMN "ITEM_CATEGORY"."L_CATEGORY_NM" IS '대분류 카테고리 이름';
...
CREATE TABLE "MIDDLE_CATEGORY" (
	"M_CATEGORY_NO"	VARCHAR(255)		NOT NULL,
	"M_CATEGORY_NM"	VARCHAR(255)		NULL,
	"CATEGORY_NO"	NUMBER		NOT NULL
);

COMMENT ON COLUMN "MIDDLE_CATEGORY"."CATEGORY_NO" IS '대분류 카테고리 번호(Like 게시글 번호)';
COMMENT ON COLUMN "MIDDLE_CATEGORY"."CATEGORY_NO" IS '중분류 카테고리 이름';
COMMENT ON COLUMN "MIDDLE_CATEGORY"."CATEGORY_NO" IS '중분류 카테고리 번호(Like 게시글 번호)';
...
ALTER TABLE "MIDDLE_CATEGORY" ADD CONSTRAINT "PK_UNTITLED" PRIMARY KEY (
	"M_CATEGORY_NO"
);
